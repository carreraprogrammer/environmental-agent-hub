"""
ColorMapper - Deterministic Material to Bin Color mapping.

ARCHITECTURE NOTE: This is a UTILITY, not an AI agent.
Pure deterministic lookup based on NTC 24 standard.
...
class ColorMapper:
    """
    Deterministic utility for mapping waste material to bin color (NTC 24).

    NOT AN AGENT: Pure dictionary lookup, no AI/ML involved.
    ...
    Synchronous operation - dictionary lookups only.
    Typical latency: <1ms.
