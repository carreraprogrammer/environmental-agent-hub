"""
WasteTypeMapper Agent - Maps waste characteristics to Backend waste type codes.

This agent is responsible for mapping the combination of material, characteristics,
and volume to the exact waste_type_code used by the Backend Rails system.
...
class WasteTypeMapper:
    """
    Maps waste material characteristics to Backend waste type codes.
